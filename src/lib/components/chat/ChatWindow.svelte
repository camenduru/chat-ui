	...
	>
		...
		<div class="w-full">
			...
			<div class="flex items-center justify-end mt-2 self-stretch px-1 text-xs text-neutral-400/90 max-md:mb-2 max-sm:gap-0">
				...
				<a href="https://www.runpod.io" target="_blank" class="flex items-center">
					<svg focusable="false" aria-hidden="true" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" version="1.0" style="width: 25px; height: 25px;">
						<g fill="#673AB7">
