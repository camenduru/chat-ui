...
<details
	class="group flex w-fit max-w-full flex-col rounded-xl border border-neutral-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-800" open
>
	<summary
		class="
		grid min-w-72 cursor-pointer select-none grid-cols-[40px,1fr,24px] items-center gap-2.5 rounded-xl p-2 group-open:rounded-b-none hover:bg-neutral-500/10"
	>
		<div
		...
		>
			<div class="grid h-dvh place-items-center">
				<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32">
					<path
						class="stroke-neutral-600 dark:stroke-neutral-400"
		...
		<dl class="leading-4">
			...
			<dt
				class="flex items-center gap-1 truncate whitespace-nowrap text-[.82rem] text-neutral-400"
	...
	<div
		class="space-y-4 border-t border-neutral-200 px-5 pb-2 pt-2 text-sm text-neutral-600 dark:border-neutral-800 dark:text-neutral-400"
	>
