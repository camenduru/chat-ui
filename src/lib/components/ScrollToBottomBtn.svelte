...
{#if visible}
	<button
		...
		class="btn absolute flex h-[41px] w-[41px] rounded-full border bg-white shadow-md transition-all hover:bg-neutral-100 dark:border-neutral-600 dark:bg-neutral-700 dark:shadow-neutral-950 dark:hover:bg-neutral-600 {className}"
